...
3. klik tombol login
4. Tampil tabel yang berisi dari data dari basis data myweb dan tabel mahasiswa
5. Jika ingin menambah data pilih "tambah data" dan isi teksbox lalu submit
6. Jika ingin mengedit data pilih "edit" lalu ubah data dan submit
7. jika ingin menghapus data pilih "delete" lalu pilih ok 
8. jika ingin keluar dari halaman pilih logout
9. End
-->
<head>
...
<?php echo $id;?>">
Edit</a> || <a href="<?php echo $root;?>&amp;act=del&amp;id=
<?php echo $id;?>" onclick="return confirm('Delete data with id <?php echo $id; echo " (".$row[1]. " )"; ?> ?');" >
Hapus</a> |
